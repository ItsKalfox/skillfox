...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Future<void> _signIn() async {
    ...
    final success = await provider.signIn(_emailCtrl.text.trim(), _passCtrl.text);
    if (!mounted) return;
    if (success) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(provider.error ?? 'Sign in failed')),
      );
    }
  }
          ...
          SafeArea(
            child: Stack(
              children: [
                ...
                // ✅ Layer 3 — bottom line INSIDE SafeArea
                // sits above home indicator, respects safe area bottom inset
                Positioned(
