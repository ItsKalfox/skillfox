  ...
  void _applyStatus(String status) {
    switch (status) {
      ...
      case 'inprogress':
        ...
        break;
      // ── NEW: arrived → worker reached customer, job started ──
      case 'arrived':
        _rejected = false;
        _stage = 3;
        _startWorkerTracking();
      ...
      case 'completed':
        ...
        _stage = 4;
        break;
      // ── NEW: quotation_sent → worker sent quotation after completing ──
      case 'quotation_sent':
        _rejected = false;
        _stage = 4;
        break;
