// ════════════════════════════════════════════════════════════════════════════
//  lib/screens/category_a/payment_options_screen.dart
// ════════════════════════════════════════════════════════════════════════════
...
class _PaymentOptionsScreenState extends State<PaymentOptionsScreen> {
  String _selected = 'cash'; // 'cash' | 'card' | 'wallet'
  ...
  Future<void> _confirmPayment() async {
    ...
    try {
      // Update Firestore status to inprogress
      ...
      if (!mounted) return;
      // Pop back to WaitingWorkerScreen — it will auto-advance to stage 4
