...
// WORKER STAGE MAP
// 0 = accepted         → waiting for customer payment
// 1 = inprogress/paid  → customer paid, show map + "Mark as Arrived"
// 2 = arrived          → timer running, "Mark as Completed"
// 3 = completed        → "Send Quotation" button
// 4 = quotation_sent   → waiting for customer response
// 5 = quotation_paid   → customer accepted & paid ✓
// 6 = quotation_declined → customer declined ✗
...
class _WorkerJobProgressScreenState extends State<WorkerJobProgressScreen>
  ...
  // ── Quotation declined card (stage 6) ─────────────────────────────────────
  ...
  Widget _bottomContent() {
    switch (_stage) {
      ...
      case 4:
        // Check if customer accepted but not yet paid
