...
class WorkerEditAddressScreen extends StatefulWidget {
  final UserAddress address;

  const WorkerEditAddressScreen({super.key, required this.address});

  @override
  State<WorkerEditAddressScreen> createState() =>
      _WorkerEditAddressScreenState();
}

class _WorkerEditAddressScreenState extends State<WorkerEditAddressScreen> {
