...
class _WorkerSignup4ScreenState extends State<WorkerSignup4Screen> {
  ...
  // Individual field error flags — set on failed submit, cleared when user types
  ...
  void initState() {
    ...
    // Clear individual error flags as user types
  ...
  void _onNext() {
    ...
    Navigator.push(context, MaterialPageRoute(
      builder: (_) => WorkerSignup5Screen(
        ...
        nicFrontUrl: widget.nicFrontUrl, nicBackUrl: widget.nicBackUrl,
  ...
  // Inline * Required label shown below an errored field
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                ...
                                hint: Padding(
                                  ...
                                  child: Text('Province',
                                    style: GoogleFonts.poppins(fontSize: 13,
                                      color: _provinceError ? const Color(0xFFE53935) : AppColors.neutral4)),
                                ),
                                icon: Padding(
                          ...
                          Row(
                            children: [
                              ...
                              if (mapError) ...[
                                ...
                                const Text('*', style: TextStyle(
                                  color: Color(0xFFE53935), fontSize: 16, fontWeight: FontWeight.bold)),
                              ...
                              Positioned(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    _mapBtn(icon: Icons.fullscreen_rounded, onTap: _openFullScreenMap),
                                  ],
                                ),
                              ),
                            ],
...
class _FullScreenMapPageState extends State<_FullScreenMapPage> {
  ...
  Future<void> _goToMyLocation() async {
    ...
    try {
      final pos = await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high);
      _ctrl?.animateCamera(CameraUpdate.newLatLngZoom(LatLng(pos.latitude, pos.longitude), 16));
    } catch (_) {}
  }
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            bottom: 0, left: 0, right: 0,
            child: Container(
              padding: EdgeInsets.only(left: 24, right: 24, top: 14, bottom: bottomPadding + 14),
              decoration: BoxDecoration(
                color: Colors.white,
