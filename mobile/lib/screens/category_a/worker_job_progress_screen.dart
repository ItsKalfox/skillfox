...
class _WorkerJobProgressScreenState extends State<WorkerJobProgressScreen>
  ...
  void _listenToRequest() {
    _sub = FirebaseFirestore.instance
        ...
        .listen((snap) {
          ...
          setState(() {
            _data = d;
            _setStageFromStatus(d['status'] as String? ?? 'accepted');
          });
        });
  }
  ...
  Future<void> _markCompleted() async {
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text(
          'Are you sure the inspection is completed? You can then send a quotation.',
        ),
        actions: [
          TextButton(
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: cols[idx][0].withOpacity(0.35),
  ...
  Widget _buildPaymentConfirmedCard() {
    final total =
        (_data['totalPaid'] as num?)?.toDouble() ??
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  total > 0
                      ? 'LKR ${_fmt(total)} paid by customer'
    ...
    child: Column(
      ...
      children: [
        ...
        Center(
          child: Text(
            _stage == 2
                ? 'Timer started when you arrived'
                : 'Total job duration',
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [_C.blue, Color(0xFF1D4ED8)],
                  ),
                  borderRadius: BorderRadius.circular(8),
                ),
                child: const Icon(
          ...
          if (jobDesc.isNotEmpty) ...[
            ...
            Text(
              jobDesc,
              style: const TextStyle(fontSize: 11, color: _C.txt2, height: 1.4),
            ),
          ],
          if (total > 0) ...[
            const SizedBox(height: 10),
          ...
          Container(
            ...
            child: const Row(
              children: [
                Icon(Icons.hourglass_top_rounded, size: 12, color: _C.blue),
                SizedBox(width: 6),
                Expanded(
                  child: Text(
                    'Waiting for customer to accept or decline the quotation.',
                    style: TextStyle(fontSize: 10, color: _C.blue, height: 1.4),
                  ),
                ),
              ],
            ),
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              const _Label('QUOTATION ACCEPTED & PAID'),
              const Spacer(),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                decoration: BoxDecoration(
          ...
          if (labour > 0)
            _Row(label: 'Labour Cost', value: 'LKR ${_fmt(labour)}'),
          if (material > 0)
            _Row(label: 'Material Cost', value: 'LKR ${_fmt(material)}'),
          const Divider(height: 16, color: _C.cardBdr),
          _Row(
            label: 'Total Received',
            value: 'LKR ${_fmt(total)}',
            valueColor: _C.green,
          ),
          const SizedBox(height: 10),
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Customer has paid. The job is now complete!',
                    style: TextStyle(
                      fontSize: 10,
                      color: _C.green,
                      height: 1.4,
  ...
  Widget _buildQuotationDeclinedCard() => _Card(
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            const _Label('QUOTATION DECLINED'),
            const Spacer(),
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
              decoration: BoxDecoration(
        ...
        Container(
          ...
          child: const Row(
            children: [
              Icon(Icons.info_outline_rounded, size: 12, color: _C.red),
              SizedBox(width: 6),
              Expanded(
                child: Text(
                  'The customer has declined your quotation. The inspection work has been completed.',
                  style: TextStyle(fontSize: 10, color: _C.red, height: 1.4),
                ),
              ),
            ],
          ),
  ...
  Widget _buildJobDoneCard() => _Card(
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            const _Label('JOB SUCCESSFULLY COMPLETED'),
          ],
        ),
        const SizedBox(height: 12),
        Container(
          ...
          child: const Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'The quotation has been completed and paid. Great work!',
  ...
  Widget _bottomContent() {
    switch (_stage) {
      ...
      case 2:
        return _gradBtn(
          label: _actionLoading ? 'Please wait…' : 'Mark as Completed',
          colors: [_C.green, _C.greenDk],
          icon: Icons.check_circle_rounded,
          onTap: _actionLoading ? null : _markCompleted,
        );
      case 3:
        return _gradBtn(
      ...
      case 4:
        ...
        if (qStatus == 'accepted') {
          return _infoBar(
            ...
            text: 'Customer accepted the quotation! Waiting for payment...',
            color: _C.green,
        ...
        return _infoBar(
          ...
          text: 'Waiting for customer to accept or decline the quotation',
          color: _C.blue,
      ...
      case 6:
        return _infoBar(
          ...
          text: 'Customer declined the quotation. Inspection was completed.',
          color: _C.red,
